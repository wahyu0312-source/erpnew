...
$("#btnSalesTpl")?.addEventListener('click', downloadSalesTemplate);
...
function editShip(po_id, ship_id, dat){
  ...
  // tambahkan ship_id tersembunyi agar update by ship_id
...
$("#btnShipTpl")?.addEventListener('click', downloadShipTemplate);
